...
class Category(models.Model):
    ...
    description = models.CharField(max_length=100, null=True, blank=True, verbose_name="category description")
...
class Task(models.Model):
    ...
    descripiton = models.CharField(max_length=100, null=True, blank=False, verbose_name="task description")
    creation_time = models.DateTimeField(auto_now_add=True)
    type = models.CharField(max_length=30, choices=[("exercise", "Exercise"),("chores", "Chores"),("academic", "Academic"),("code", "Code"),("habit","Habit"),("other","Other")], default="NA")
    status = models.BooleanField(default=False)
